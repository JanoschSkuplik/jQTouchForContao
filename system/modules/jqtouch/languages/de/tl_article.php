...
$GLOBALS['TL_LANG']['tl_article']['jqt_legend'] = 'jQTouch';


$GLOBALS['TL_LANG']['tl_article']['jqt_toolbar'] = array('jQTouch: Toolbar anzeigen','Für diesen Artikel die Toolbar anzeigen.');
$GLOBALS['TL_LANG']['tl_article']['jqt_toolbarBackBtn'] = array('jQTouch: zurück-Button anzeigen','Einen zurück-Button innerhalb der Toolbar anzeigen.');
$GLOBALS['TL_LANG']['tl_article']['jqt_toolbarTitle'] = array('jQTouch: Toolbar-Titel anzeigen','Einen Seitentitel in der Toolbar anzeigen.');
$GLOBALS['TL_LANG']['tl_article']['jqt_toolbarRightBtn'] = array('jQTouch: rechten Button anzeigen','Einen rechten Button in der Toolbar anzeigen.');
